...
const Dashboard = () => {
    ...
    const menu = {
        ...
        menuOptionsCarGuard : { menuName: "Pernoite", icon: 'car', key: 'car', url: 'CarSearch', code: 'Cars' },
        menuOptionsEventResident : { menuName: "Ocorrências", icon: 'exclamation', key: 'event', url: 'EventAdd', code: 'Events' },
        menuOptionsEventGuard : { menuName: "Ronda", icon: 'exclamation', key: 'event', url: 'EventAdd', code: 'Events' },
