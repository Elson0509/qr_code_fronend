          ...
          <div className={classes.FooterPrivacy}>
            ...
            <ul>
              <li><button className={classes.ButtonLink} onClick={() => setModalTerms(true)}>Termos e condições</button></li>
              {
                user ?
                  <li>
                    <button className={classes.ButtonLink} onClick={() => setModalPrivacy(true)}>Política de privacidade</button>
                  </li>
                  :
                  <li>
                    <Link className={classes.ButtonLink} to={'/privacy'}>Política de privacidade</Link>
                  </li>
              }
            </ul>
          </div>
